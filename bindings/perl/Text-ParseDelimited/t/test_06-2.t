...
my $data = "\" a, b ,c \", a b  c,";
my $results = [
  {'event_type' => PDT_FLD, 'size' => 9, 'data' => " a, b ,c "},
  {'event_type' => PDT_FLD, 'size' => 6, 'data' => "a b  c"},
  {'event_type' => PDT_FLD, 'size' => 0, 'data' => ""},
  {'event_type' => PDT_REC, 'eol' => "\0"},
  {'event_type' => PDT_END}
];

ok(TestEngine::run_test("test_06-2", Text::ParseDelimited::PDT_STRICT, $data, length($data), $results, ",", "\""), "parse >$data<");
