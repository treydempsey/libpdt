...
field_callback_shim(ParseDelimitedText * self, String * field)
{
  ...
  if(xs->field_callback != NULL) {
    ...
    sv_setref_pv(parser_sv, "Text::ParseDelimitedCB", (void *)xs_cb);
...
MODULE = Text::ParseDelimited PACKAGE = Text::ParseDelimited
...
BOOT:
{
  ...
  stash = gv_stashpvn("Text::ParseDelimited", 20, TRUE);
...
new(options)
  ...
  PPCODE:
    ...
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Text::ParseDelimitedXS", (void *)xs);
    XSRETURN(1);



MODULE = Text::ParseDelimited PACKAGE = Text::ParseDelimitedXS
...
BOOT:
{
  ...
  stash = gv_stashpvn("Text::ParseDelimitedXS", 22, TRUE);
...
MODULE = Text::ParseDelimited PACKAGE = Text::ParseDelimitedCB
